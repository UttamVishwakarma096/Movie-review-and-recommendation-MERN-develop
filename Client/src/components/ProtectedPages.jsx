...
function ProtectedPage({ children }) {
  ...
  if (isAdminPage) {
    if (user === null) {
      // User not loaded yet, show spinner
      return (
  ...
  return (
    <div>
      <div className='flex justify-between items-center bg-primary p-5'>
        ...
        <div className='bg-white rounded px-5 py-2 flex gap-4 items-center'>
          <svg
          ...
          <button
            className='text-primary text-sm border border-primary rounded px-2 py-1 cursor-pointer'
